  ...
  experience: [
    {
      ...
      description: [
        'Architected and implemented full-stack migration (React.js + Spring Boot) from monolithic legacy platform, delivering MVP frontend in under 2 weeks and backend APIs within 10 days.',
